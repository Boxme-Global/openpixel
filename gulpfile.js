...
let process = {
    env: {
        ...
        OPIX_JS_ENDPOINT: 'https://cdn.omisocial.com/tracking//omisocial.pixel.min.js',
        OPIX_VERSION: '1.0'
    }
}
...
function openpixel() {
    return gulp.src([
        ...
        .pipe(concat('omisocial.pixel.js'))
        .pipe(babel())
        .pipe(iife({
            useStrict: false,
