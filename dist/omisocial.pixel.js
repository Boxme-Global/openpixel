...
var Cookie = /*#__PURE__*/function () {
  ...
  _createClass(Cookie, null, [{
    ...
    value: function get(name) {
      var _name = "".concat(this.prefix()).concat(name, "=");
    ...
    value: function setUtms() {
      ...
      for (var _i2 = 0, _l = utmArray.length; _i2 < _l; _i2++) {
        if (Helper.isPresent(Url.getParameterByName(utmArray[_i2]))) {
          exists = true;
          break;
        }
      }
      ...
      if (exists) {
        ...
        for (var _i3 = 0, _l2 = utmArray.length; _i3 < _l2; _i3++) {
          val = Url.getParameterByName(utmArray[_i3]);

          if (Helper.isPresent(val)) {
            save[utmArray[_i3]] = val;
          }
        }
    ...
    key: "setOtms",
    value: function setOtms() {
      var otmArray = ['otm_source', 'otm_medium', 'otm_campaign', 'otm_position'];
      var exists = false;

      for (var _i4 = 0, _l3 = otmArray.length; _i4 < _l3; _i4++) {
        if (Helper.isPresent(Url.getParameterByName(otmArray[_i4]))) {
          exists = true;
          break;
        }
      }
      ...
      if (exists) {
        ...
        for (var _i5 = 0, _l4 = otmArray.length; _i5 < _l4; _i5++) {
          val = Url.getParameterByName(otmArray[_i5]);

          if (Helper.isPresent(val)) {
            save[otmArray[_i5]] = val;
          }
        }
    ...
    key: "getOtm",
    value: function getOtm(name) {
      if (this.exists('otm')) {
        var otms = JSON.parse(this.get('otm'));
  ...
  _createClass(Pixel, [{
    ...
    value: function getAttribute() {
      ...
      return _objectSpread({
        ...
        // user Id
        event_name: function event_name() {
          return _this.event;
        },
        // event being triggered
        event_data: function event_data() {
        ...
        document_encoding: function document_encoding() {
          return document.characterSet;
        },
        // document encoding
        screen_size: function screen_size() {
        ...
        // viewport size
        color_deep: function color_deep() {
        ...
        // document title
        brower_name: function brower_name() {
        ...
        // user agent
        timezone_offset: function timezone_offset() {
        ...
        otm_source: function otm_source(key) {
          return Cookie.getOtm(key);
        },
        // get the otm source - for Omisocial tracking
        otm_medium: function otm_medium(key) {
          return Cookie.getOtm(key);
        },
        // get the otm medium - for Omisocial tracking
        otm_campaign: function otm_campaign(key) {
          return Cookie.getOtm(key);
        },
        // get the otm campaign - for Omisocial tracking
        otm_position: function otm_position(key) {
          return Cookie.getOtm(key);
        }
      }, Config.params);
    }
...
Cookie.setUtms(); // save any otms through as session cookies

Cookie.setOtms(); // process the queue and future incoming commands
